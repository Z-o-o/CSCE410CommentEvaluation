...
class Question:
    def __init__(self, question_id, title, answers, tags, body, accepted_answer_id):
        self.question_id = question_id
        self.title = title
        self.answers = answers
        self.tags = tags
        self.body = body
        self.accepted_answer = accepted_answer_id
...
question = Question(question_id=current_qa_pointer['question_id'], title=current_qa_pointer['question_title'],
                    ...
                    accepted_answer_id=['question_accepted_answer_id'])
...
for answer in all_python_questions[len(all_python_questions)-1].answers:
    print(answer.body)